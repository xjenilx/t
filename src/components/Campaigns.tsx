        ...
        <div className="min-h-screen pt-24 pb-20 px-4">
            <div className="max-w-7xl mx-auto">
                  ...
                  hover:shadow-2xl transition-all duration-300 hover:-translate-y-1`}
                            ...
                            >
                                ...
                                <div className="relative aspect-[3/4] overflow-hidden bg-black/30">
                                    ...
                                    {/* Category */}
                                    <div className="absolute top-3 right-3 bg-black/50 backdrop-blur text-white/70 text-[10px] font-semibold px-2.5 py-1 rounded-full">
                                        {campaign.category}
                                    </div>
                                ...
                                <div className="p-4">
                                    <div className="flex items-start justify-between gap-2 mb-1.5">
                                        ...
                                        <ChevronRight className="w-4 h-4 text-white/30 shrink-0 mt-0.5 group-hover:text-white/60 transition-colors" />
                                    </div>
                                    <p className="text-xs font-semibold mb-1" style={{ color: campaign.color }}>{campaign.campaign}</p>
                                    <p className="text-xs text-white/40 leading-snug line-clamp-2">{campaign.description}</p>
                                </div>
                            </motion.div>
                        );
                    })}
                ...
                <div className="mt-16 text-center">
                    <p className="text-white/20 text-xs">Images generated by Pollinations AI • Flux Model</p>
                </div>
            </div>
                    ...
                    return (
                                ...
                                <div className="p-5 grid md:grid-cols-2 gap-6">
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <div className="relative rounded-2xl overflow-hidden border border-white/10">
                                            ...
                                            />
                                            <div className="absolute bottom-2 left-2 bg-black/60 backdrop-blur text-white/60 text-[10px] px-2 py-1 rounded-lg">
                                        ...
                                        {vs?.status === 'rendering' && (
                                            <div className="rounded-2xl border border-white/10 bg-white/5 p-5 text-center">
                                                ...
                                                <p className="text-xs text-white/30 mt-1.5 font-mono">{vs.progress}%</p>
                                            </div>
                                        )}
                                    </div>
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-white/70 leading-relaxed">{selectedCampaign.description}</p>
                                        </div>
                                        ...
                                        <div className={`bg-gradient-to-br ${selectedCampaign.gradient} border ${selectedCampaign.border} rounded-xl p-4 space-y-2`}>
                                            ...
                                            <div className="flex justify-between text-xs">
                                                <span className="text-white/40">Era</span>
                          ...
                          text-white py-3.5 rounded-xl font-black flex items-center justify-center gap-2 shadow-xl shadow-purple-500/20"
                                        ...
                                        {vs?.status === 'ready' && (
                                            <button
                                                ...
                                                className="w-full border border-white/10 hover:bg-white/5 text-white/60 hover:text-white py-3 rounded-xl text-sm font-semibold transition-all"
                                            >
                                                Regenerate Video
                                            </button>
                                        )}
                        ...
                        hover:bg-indigo-500/20 text-indigo-300 py-3 rounded-xl font-black text-sm transition-all"
                                        ...
                                        <div className="bg-black/30 rounded-xl p-3 border border-white/5">
                                            <p className="text-[10px] text-white/30 uppercase font-bold tracking-widest mb-1.5">AI Prompt</p>
                                            <p className="text-[11px] text-white/50 leading-relaxed font-mono line-clamp-4">
                                        ...
                                        <div className="flex gap-2 pt-1">
                                            {CAMPAIGNS.indexOf(selectedCampaign) > 0 && (
                                                <button
                                                    ...
                                                    className="flex-1 flex items-center justify-center gap-1 py-2 text-xs text-white/40 hover:text-white transition-colors"
                                                >
                                                    ← Prev
                                                </button>
                                            )}
